...
## Summary
- 437 nodes · 542 edges · 21 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b221c6f7`
...
Cohesion: 0.09
Nodes (32): ArgumentParser, _contains(), evaluate_events(), evaluate_observation(), format_result(), _internal_artifact(), load_observation(), main() (+24 more)
...
### Community 8 - "3. Usage"
Cohesion: 0.06
Nodes (30): 1.1. Identifiers, 1.2. Ordering, 1.3. Formatting, 1. Style, 2.1. Comments, 2.2. Doc Comments, 2.3. Markdown, 2.4. Writing (+22 more)
...
### Community 10 - "_load_module"
Cohesion: 0.27
Nodes (7): _load_module(), Any, QualityComparisonEdgeTests, add(), Load one implementation module for edge-case coverage., Exercise validation failures not needed by the primary contract tests., Build independent malformed comparisons for validation coverage.
...
### Community 20 - "Saturation evals"
Cohesion: 0.29
Nodes (6): Boundary, CLI, Observation hook, Run the tests, Saturation evals, What is measured

## Knowledge Gaps
- **213 isolated node(s):** `Core promise`, `Lifecycle`, `Persistence boundary`, `Context and trust`, `Scoped subagents` (+208 more)
